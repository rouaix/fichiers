...
Requête 14
select film.id_genre, genre.nom, count(film.id_film) from film join genre ON film.id_genre = genre.id_genre where film.id_genre between '1' and '3' group by film.id_genre
